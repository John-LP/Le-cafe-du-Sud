...
addButton.addEventListener("click", function () {
  if (type.value == "soft") {
    ...
    liste.innerHTML = `<p class="nomProduit">${produit.value} (${stock.value})</p>
...
//     soft.innerHTML = "";
//     LSsoft.forEach(function (produit.value,stock.value,prixAchatHt,prixVenteHt,margeHt,prixTtc) {
//         alcool.innerHTML += `<div class="liste"><p class="nomProduit">${produit.value} (${stock.value})</p>
//         <select class="details">
//         <option>TTC : ${prixTtc}€</option>
//         <option>Achat HT : ${prixAchatHt}€</option>
//         <option>Vente HT : ${prixVenteHt}€</option>
